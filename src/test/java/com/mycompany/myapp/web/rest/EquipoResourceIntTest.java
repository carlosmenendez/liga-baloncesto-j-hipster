...
public class EquipoResourceIntTest {
    ...
    private static final String DEFAULT_TUMADRE = "AAAAA";
    private static final String UPDATED_TUMADRE = "BBBBB";
    ...
    public void initTest() {
        ...
        equipo.setFechaFundacion(DEFAULT_FECHA_FUNDACION);
        equipo.setLocalidad(DEFAULT_LOCALIDAD);
        equipo.setTumadre(DEFAULT_TUMADRE);
    }
    ...
    public void createEquipo() throws Exception {
        ...
        assertThat(testEquipo.getFechaFundacion()).isEqualTo(DEFAULT_FECHA_FUNDACION);
        assertThat(testEquipo.getLocalidad()).isEqualTo(DEFAULT_LOCALIDAD);
        assertThat(testEquipo.getTumadre()).isEqualTo(DEFAULT_TUMADRE);
    }
    ...
    public void getAllEquipos() throws Exception {
        ...
        restEquipoMockMvc.perform(get("/api/equipos"))
                ...
                .andExpect(jsonPath("$.[*].tumadre").value(hasItem(DEFAULT_TUMADRE.toString())));
    }
    ...
    public void getEquipo() throws Exception {
        ...
        restEquipoMockMvc.perform(get("/api/equipos/{id}", equipo.getId()))
            ...
            .andExpect(jsonPath("$.tumadre").value(DEFAULT_TUMADRE.toString()));
    }
    ...
    public void updateEquipo() throws Exception {
        ...
        equipo.setFechaFundacion(UPDATED_FECHA_FUNDACION);
        equipo.setLocalidad(UPDATED_LOCALIDAD);
        equipo.setTumadre(UPDATED_TUMADRE);
        ...
        assertThat(testEquipo.getFechaFundacion()).isEqualTo(UPDATED_FECHA_FUNDACION);
        assertThat(testEquipo.getLocalidad()).isEqualTo(UPDATED_LOCALIDAD);
        assertThat(testEquipo.getTumadre()).isEqualTo(UPDATED_TUMADRE);
    }
